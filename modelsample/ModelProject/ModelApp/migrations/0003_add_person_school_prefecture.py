...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='person',
            name='create_at',
            field=models.DateTimeField(default=datetime.datetime(2023, 7, 20, 23, 34, 42, 361905, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
            model_name='person',
            name='update_at',
            field=models.DateTimeField(default=datetime.datetime(2023, 7, 20, 23, 34, 42, 361938, tzinfo=datetime.timezone.utc)),
        ),
        migrations.CreateModel(
            name='Students',
            fields=[
